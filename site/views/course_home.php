<div class="container">
    ...
    <div class="col-lg-1">
        ...
        <div class="col-lg-10">
            <h2 style="color: #9a9898;font-size: 25px;"><?php echo $this->setting_model->get('course_title'); ?></h2>
        </div>
        <div class="col-lg-1">
        </div>
    </div>
    ...
    <div class="col-lg-1">
        ...
        <div class="col-lg-10">
            <h3>Course Home</h3>
            <p><?php echo $this->setting_model->get('course_home_header_text'); ?></p>
        </div>
        <div class="col-lg-1">
        </div>
    </div>
                            ...
                            foreach ($dataSets as $key => $value) {
                                ...
                                if (strcasecmp($moduleType, 'video') == 0) {
                                    ...
                                    echo "<li class=\"module-content list-group-item\">";
                                        ...
                                        echo "<li class=\"col-lg-9 col-sm-6 col-xs-6\"><a href=\"".site_url('dashboard/play_video/'.$rowVideoModule->module_id.'/'.$video_page)."\" class=\"links\" title=\"Video\">".$rowVideoModule->title."</a></li>";
                                        echo "<li class=\"col-lg-1 col-sm-2 col-xs-6\"><a href=\"".site_url('dashboard/play_video/'.$rowVideoModule->module_id.'/'.$video_page)."\" class=\"links\" title=\"Video\"><i class=\"far fa-play-circle\"></i></a></li>";
                                ...
                                if (strcasecmp($moduleType, 'quiz') == 0) {
                                    ...
                                    echo "<li class=\"module-content list-group-item\">";
                                        echo "<ul class=\"row list-unstyled\">";
                                        echo "<li class=\"col-lg-1 col-sm-2 col-xs-6\">Unit ".$lesson."</li>";
                                        echo "<li class=\"col-lg-9 col-sm-6 col-xs-6\"><a href=\"".site_url('dashboard/quiz/'.$rowQuizModule->module_id.'/'.$rowQuizModule->id)."\" class=\"links\" title=\"Quiz\">".$rowQuizModule->title."</a></li>";
                                        echo "<li class=\"col-lg-1 col-sm-2 col-xs-6\"><a href=\"".site_url('dashboard/quiz/'.$rowQuizModule->module_id)."\" class=\"links\" title=\"Quiz\"><i class=\"far fa-question-circle\"></i></a></li>";
                                        echo "<li class=\"col-lg-1 col-sm-2 col-xs-6\"></li>";
                                        echo "</ul>";
                                    echo "</li>";
                                }
