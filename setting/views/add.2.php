...
<option value = "N" <?php echo strcasecmp($result->credit_card_registration, 'N') == 0 ? "selected" : NULL ?>>OFF</option>
<option value = "Y" <?php echo strcasecmp($result->credit_card_registration, 'Y') == 0 ? "selected" : NULL ?>>ON</option>
                                        </select>
                                        <?php
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php echo form_textarea('course_home_header_text', set_value('course_home_header_text', isset($result->course_home_header_text) ? $result->course_home_header_text : ''), "class=\"form-control\""); ?>
