                            ...
                            <?php if ($query) { ?>
                                ...
                                ?>
                                    ...
                                    <input type="checkbox" name="my_check[]"  value="<?php echo $row->id; ?>" class="custom-control-input">
                                        ...
                                        <td><a href="<?php echo site_url('student/session/'.$row->id); ?>"><?php echo $row->session_name; ?></a></td>
                                        ...
                                        <td class="text-center"><a href="<?php echo site_url('student/billing/'.$row->id); ?>">Billing</a></td>
                                        <td class="text-center">
                                            <?php
                                                if($row->status){
