...
<div class="form-row">
    <div class="col-md-12" style="margin-top: 19px;">
        ...
        <?php if($this->uri->segment(2)=='guest_roster'):?>
            <a href="<?php echo site_url('student/add_guest/'); ?>" class="btn btn-primary " role="button"><i class="fa fa-plus"></i> Add Guest</a>
            <button type="submit" name="action_invite" value="invite" class="btn btn-primary">Invite</button>
        <?php  elseif($this->uri->segment(2)=='roster'): ?>
        <?php /* ?>
            <a href="<?php echo site_url('student/add/'); ?>" class="btn btn-primary" role="button"><i class="fa fa-plus"></i> Add Student</a>
      <?php */ ?>
      ...
      <a href="<?php echo site_url('student/export_roster_csv/'.$export); ?>" class="btn btn-primary">Download CSV</a>
                            ...
                            <?php if ($query) { ?>
                                ...
                                ?>
                                    ...
                                    <input type="checkbox" name="my_check[]"  value="<?php echo $row->id; ?>" class="custom-control-input">
                                        ...
                                        <a href="<?php echo site_url('student/add/'.$row->id.'/?ref='.$this->router->fetch_method()); ?>" class="btn btn-info" style="padding:2px 5px 0px 5px; float:left;"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="<?php echo site_url('student/delete/'.$row->id.'?back='.current_url());?>" class="btn btn-danger" style="padding:2px 5px 0px 5px; float:right;" onclick="return ask('Do you want to delete?');"><i class="fa fa-trash-o"></i></a>
