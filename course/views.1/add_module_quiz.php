...
<?php if ($this->uri->segment(5)) : ?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addQuestion">Add Question</button>
                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addQuizComment">Add Quiz Comments</button>
                </div>

                <div class="panel-body">

                    <div class="table-responsive">
                        <table class="table table-bordered" style="margin-top: 20px;" <thead>
                            <tr>
                                <th>QN</th>
                                <th>Question</th>
                                <th>Order</th>
                                ...
                                if ($queryQuestion) {
                                    ...
                                    foreach ($queryQuestion->result() as $rowQuestion) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $rowQuestion->_order; ?></td>
                                            <td>
...
?>
                    <?php for ($i = 0; $i <= 9; $i++) : ?>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-2">
                                    <input type="text" name="scores[]" class="form-control" value="<?php echo isset($scores_arr[$i])?$scores_arr[$i]:NULL; ?>" required>
                                </div>
                                <div class="col-lg-10">
                                    <input type="text" name="comments[]" class="form-control" value="<?php echo isset($comments_arr[$i])?$comments_arr[$i]:NULL; ?>" required>
                                </div>
                            </div>
                        </div>
                    <?php endfor; ?>
