...
<div class="page-container">
    ...
    <div class="page-sidebar">
        ...
        <ul class="x-navigation">
            <li class="xn-logo">
                <a href="<?php echo base_url(); ?>">CCIT</a>
                <a href="#" class="x-navigation-control"></a></li>


            <li class="active">
                <a href="<?php echo site_url('members/dashboard'); ?>"><span class="fa fa-desktop"></span> <span class="xn-text">Dashboard</span></a></li>

            <li class="xn-openable">
                <a href="#"><span class="fa fa-arrow-right"></span>Travel</span></a>
                <ul>
                <li>
                        <a href="<?php echo site_url('travel/search') ?>"><span class="fa fa-long-arrow-right"></span>  Search Trip</a>
                    </li>
                    
                    <li>
                        <a href="<?php echo site_url('travel/destination') ?>"><span class="fa fa-long-arrow-right"></span>  Manage Destination</a>
                    </li>

                    <li>
                        <a href="<?php echo site_url('travel/activity') ?>"><span class="fa fa-long-arrow-right"></span>  Manage Activity</a>
                    </li>

                    <li>
                        <a href="<?php echo site_url('travel/region') ?>"><span class="fa fa-long-arrow-right"></span>  Manage Region</a>
                    </li>

                    <li>
                        <a href="<?php echo site_url('travel/trip_group') ?>"><span class="fa fa-long-arrow-right"></span>  Manage Trip Group</a>
                    </li>


                    <li>
                        <a href="<?php echo site_url('travel/trip') ?>"><span class="fa fa-long-arrow-right"></span>  Manage Trip</a>
                    </li>
            ...
            <li class="xn-openable">
                <a href="#"><span class="fa fa-arrow-right"></span>Manage Post</span></a>
                <ul>
                     <li><a href="<?php echo site_url('post_type/manage') ?>"><span class="fa fa-long-arrow-right"></span> Post Type</a></li>
                    <li><a href="<?php echo site_url('post_category/manage') ?>"><span class="fa fa-long-arrow-right"></span> Post Category</a></li>

                    <?php
                    $post_type_query =$this->db->query('select id, uri, title from post_type order by id desc');
                    if($post_type_query)
                    {
                        foreach($post_type_query->result() as $row)
                        {
                            echo '<li><a href="'.site_url('post/get_posts/'.$row->id).'"><span class="fa fa-long-arrow-right"></span>'.$row->title.'</a></li>';
                        }
                    }
                    ?>
                </ul>
            ...
            <li class="xn-openable">
                <a href="#"><span class="fa fa-arrow-right"></span>Manage Page</span></a>
                <ul>
                    <li><a href="<?php echo site_url('page_category/manage') ?>"><span class="fa fa-long-arrow-right"></span> Manage Page Category</a></li>
                    <li><a href="<?php echo site_url('page/manage') ?>"><span class="fa fa-long-arrow-right"></span> Pages</a></li>
                </ul>
            </li>


            <li class="xn-openable">
                <a href="#"><span class="fa fa-arrow-right"></span>Manage Banner</span></a>
                <ul>
                    <li><a href="<?php echo site_url('banner/manage') ?>"><span class="fa fa-long-arrow-right"></span> Banner</a></li>
                </ul>
            </li>
...
<!-- END BREADCRUMB -->
        ...
        <div class="page-content-wrap">
            ...
            <?php //$this->load->view(isset($navigation) ? $navigation : 'template_not_set'); ?>
...
<script>
    (function ($) {
        $('#example').DataTable();
        $("#preferred_college_id").chained("#preferred_country_id");
